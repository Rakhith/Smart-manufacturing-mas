# Maintenance Action Evaluation Request: State `DS_AI4I_1142`
...
- `Process temperature [K]`: 307.9000
- `Air temperature [K]__canonical_degC`: 23.7500
- `Process temperature [K]__canonical_degC`: 34.7500
### Subsystem: Mechanical
- `Torque [Nm]`: 43.9000
### Subsystem: Kinematic
- `Rotational speed [rpm]`: 1423
