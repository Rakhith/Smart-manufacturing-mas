# Maintenance Action Evaluation Request: State `DS_AI4I_1399`
...
### Subsystem: Thermal
- `Air temperature [K]`: 299.0000
- `Process temperature [K]`: 310.2000
- `Air temperature [K]__canonical_degC`: 25.8500
- `Process temperature [K]__canonical_degC`: 37.0500
