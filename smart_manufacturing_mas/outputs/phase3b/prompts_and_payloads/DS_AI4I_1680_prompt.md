# Maintenance Action Evaluation Request: State `DS_AI4I_1680`
...
- `Process temperature [K]`: 307.4000
- `Air temperature [K]__canonical_degC`: 24.7500
- `Process temperature [K]__canonical_degC`: 34.2500
### Subsystem: Mechanical
- `Torque [Nm]`: 34.6000
### Subsystem: Kinematic
- `Rotational speed [rpm]`: 1610
