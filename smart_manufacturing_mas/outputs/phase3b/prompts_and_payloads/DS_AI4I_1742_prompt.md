# Maintenance Action Evaluation Request: State `DS_AI4I_1742`
...
### Subsystem: Thermal
- `Air temperature [K]`: 298.5000
- `Process temperature [K]`: 308.0000
- `Air temperature [K]__canonical_degC`: 25.3500
- `Process temperature [K]__canonical_degC`: 34.8500
