...
- Replaces SLM 1 (Perception/Schema Discovery) with pandas-based analysis
- Column role detection uses regex patterns and data characteristics, NOT language models
- Target variable suggestion uses heuristics based on column names and data types
- HITL operator selection provides final confirmation
"""
